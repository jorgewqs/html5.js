...
b.styles&&(c=h(a),d=c.sheet))c.sheet=null,o(d,c);return a}var C={methods:!0,print:!0,styles:!0},u={},G=n.html5,k="abbr article aside audio bdi canvas data datalist details figcaption figure footer header main mark meter nav output progress section summary time video".split(" "),m="html5js",p=m+/\d+$/.exec(Math.random()),F=/^$|\b(?:all|print)\b/,x=/^(?:button|select)$/i,w=/^<\?/,B=1,q={},g={};(function(){var a,b,c;try{c=new ActiveXObject("https:"==location.protocol&&"htmlfile")}catch(d){(c=
