...
b.styles&&(c=h(a),d=c.sheet))c.sheet=null,o(d,c);return a}var C={methods:!0,print:!0,styles:!0},u={},G=n.html5,k="abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "),m="html5js",p=m+/\d+$/.exec(Math.random()),F=/^$|\b(?:all|print)\b/,x=/^(?:button|select)$/i,w=/^<\?/,B=1,q={},g={};(function(){var a,b,c;try{c=new ActiveXObject("https:"==location.protocol&&"htmlfile")}catch(d){(c=f.createElement("iframe")).name=
p,c.frameBorder=c.height=c.width=0,b=f.body||f.documentElement,b.insertBefore(c,b.firstChild),c=(c=c.contentWindow||c.contentDocument||frames[p]).document||c}c.write("<!doctypehtml><title></title><body><script>document.w=this<\/script>");c.close();a=c.body.appendChild(c.createElement("p"));a.innerHTML="<nav/>";g.html5Styles=!!a.firstChild&&"block"==(a.firstChild.currentStyle||c.w.getComputedStyle(a.firstChild,null)).display;var e=g,h;if(!(h=1==a.childNodes.length))a:{try{f.createElement("p")}catch(k){h=
